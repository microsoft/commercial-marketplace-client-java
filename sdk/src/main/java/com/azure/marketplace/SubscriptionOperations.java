...
public final class SubscriptionOperations {
     ...
     */
    SubscriptionOperations(SaaSFulfillmentAPIsVersion2 client) {
        this.service = RestProxy.create(SubscriptionOperationsService.class, client.getHttpPipeline());
        this.client = client;
    }

    /**
     * The interface defining all the services for SaaSFulfillmentAPIsVersion2SubscriptionOperations to be used by the
