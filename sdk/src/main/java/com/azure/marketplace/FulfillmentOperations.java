...
import com.azure.marketplace.models.FulfillmentOperationsDeleteSubscriptionResponse;
import com.azure.marketplace.models.FulfillmentOperationsUpdateSubscriptionResponse;
...
import com.azure.marketplace.models.SubscriptionsResponse;
...
public final class FulfillmentOperations {
    ...
    private final SaaSFulfillmentAPIsVersion2 client;
     ...
     */
    FulfillmentOperations(SaaSFulfillmentAPIsVersion2 client) {
        this.service = RestProxy.create(FulfillmentOperationsService.class, client.getHttpPipeline());
        this.client = client;
    }

    /**
     * The interface defining all the services for SaaSFulfillmentAPIsVersion2FulfillmentOperations to be used by the
     * proxy service to perform REST calls.
     */
    @Host("{$host}")
    @ServiceInterface(name = "SaaSFulfillmentAPIsV")
