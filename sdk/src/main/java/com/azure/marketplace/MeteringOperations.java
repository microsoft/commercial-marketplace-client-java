...
public final class MeteringOperations {
     ...
     */
    MeteringOperations(SaaSFulfillmentAPIsVersion2 client) {
        this.service = RestProxy.create(MeteringOperationsService.class, client.getHttpPipeline());
        this.client = client;
    }

    /**
     * The interface defining all the services for SaaSFulfillmentAPIsVersion2MeteringOperations to be used by the proxy
