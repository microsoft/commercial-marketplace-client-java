...
public class SaasMarketplaceMeterApiTest {
    ...
    public void postBatchUsageEventTest() throws ApiException {
        ...
        UsageEventOkResponse response = api.postBatchUsageEvent(body, authorization, apiVersion, xMsRequestid, xMsCorrelationid);
    ...
    public void postUsageEventTest() throws ApiException {
        ...
        UUID xMsRequestid = null;
        UUID xMsCorrelationid = null;
        UsageEventOkResponse response = api.postUsageEvent(body, authorization, apiVersion, xMsRequestid, xMsCorrelationid);
